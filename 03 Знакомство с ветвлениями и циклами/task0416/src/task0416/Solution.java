...
public class Solution {
    ...
    public static void color(double a) {
        Scanner sc = new Scanner(System.in);
        if (a >= 0 && a < 60) {
            System.out.println(a % 5.0 < 3.0 ? "зелёный" : a % 5.0 < 4.0 ? "желтый" : "красный");
        } else {
            System.out.println("Неправильное число! Введите значение от 0 до 59");
            color(sc.nextDouble());
        }
    }
}